...
<head>
  ...
  <title>SPP | SDIT INSAN MADANI BEKASI | Login</title>
  ...
  <div class="row">
    <div class="col-md-5">
      <div class="logo hidden-xs hidden-sm">
        ...
        <img src="<?php echo media_url('img/icon.png') ?>" class="img-responsive">
        <?php } else { ?>
        <img src="<?php echo upload_url('school/' . $setting_logo['setting_value']) ?>" class="img-responsive">
        <?php } ?>
      </div>
      <p class="merk"><span style="color: #2ABB9B">SPP</span> </p> 
      <?php if (isset($setting_school) AND $setting_school['setting_value'] == '-') { ?>
      <p class="school">Sistem Pembayaran SDIT INSAN MADANI BEKASI</p> 
      <?php } else { ?>
